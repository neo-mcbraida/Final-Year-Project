...
def scale_size(images):
    # make image 3 channels so it is compatible with inception model input
...
X_test = X_test[0:1900] # making it divisible by 10 makes it easier when calling compute fid, only loose a few samples
